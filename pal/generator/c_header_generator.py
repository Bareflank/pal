...
class CHeaderGenerator(AbstractGenerator):
    ...
    @pal.gadget.external_component
    def _generate(self, outfile, regs):

        for reg in regs:
            self.gadgets["pal.c.enum"].indent = 0
            self.gadgets["pal.c.function_definition"].indent = 0
            ...
            self.gadgets["pal.c.enum"].indent = 1
            self.gadgets["pal.c.function_definition"].indent = 1
