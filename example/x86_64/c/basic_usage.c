...
int main(void)
{
    ...
    pal_print_ia32_feature_control_from_value(msr_value);
    ...
    pal_print_leaf_02_eax_from_value(cpuid_outputs.eax);
    pal_print_leaf_02_ebx_from_value(cpuid_outputs.ebx);
    pal_print_leaf_02_ecx_from_value(cpuid_outputs.ecx);
    pal_print_leaf_02_edx_from_value(cpuid_outputs.edx);
