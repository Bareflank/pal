...
void test_ia32_feature_control_compile(void)
{
    ...
    // Printers
    pal_print_ia32_feature_control(printf);
    pal_print_ia32_feature_control_from_value(printf, value);
    pal_print_ia32_feature_control_enable_vmx_inside_smx(printf);
    pal_print_ia32_feature_control_enable_vmx_inside_smx_from_value(printf, value);
    pal_print_ia32_feature_control_senter_local_function_enable(printf);
    pal_print_ia32_feature_control_senter_local_function_enable_from_value(printf, value);
}
