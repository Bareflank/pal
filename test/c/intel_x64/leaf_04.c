...
void test_leaf_04_compile(void)
{
    ...
    // Printers
    pal_print_leaf_04_eax_at_index(1);
    pal_print_leaf_04_eax_from_value(eax);
    pal_print_leaf_04_eax_self_initializing_cache_level_at_index(1);
    pal_print_leaf_04_eax_self_initializing_cache_level_from_value(eax);
    pal_print_leaf_04_eax_cache_type_at_index(1);
    pal_print_leaf_04_eax_cache_type_from_value(eax);
}
